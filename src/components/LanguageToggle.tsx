...
export const LanguageToggle = () => {
  ...
  return (
    ...
    className="text-select-none ml-4 px-4 py-2  bg-gray-800 text-white font-medium text-sm rounded-md hover:bg-gray-700 hover:text-red-400 focus:outline-none focus:ring-2 focus:ring-red-500 transition-all duration-300"
  >
